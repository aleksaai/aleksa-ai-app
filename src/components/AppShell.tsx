    ...
    <div className="relative min-h-screen overflow-x-clip">
      ...
      <div className="relative z-20 flex items-center justify-between px-4 py-3 lg:hidden">
        <Link to="/admin" className="flex items-center gap-2">
          <Logo />
          <span className="text-base font-semibold tracking-tight">OpenPenguin Voice</span>
        </Link>
        <button
          aria-label="Menü"
          ...
          <div className="px-6 py-7">
            <Link to="/admin" className="flex items-center gap-2.5">
              ...
              <div className="flex flex-col leading-none">
                <span className="text-base font-semibold tracking-tight text-ink">OpenPenguin Voice</span>
                <span
